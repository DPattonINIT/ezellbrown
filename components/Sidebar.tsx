            ...
            >
                <nav className="flex flex-col items-center  py-60 space-y-6">
                    {['HOME', 'INFO', 'EVENTS', 'BOOKING'].map((item) => (
                        ...
                        //     className="text-white text-xl px-6 py-3 rounded-md transform transition duration-200 hover:scale-105"
                        //     style={{ transition: 'background-color 0.2s ease', backgroundColor: 'transparent' }}
                        //     onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#f3eb00')}
