...
//           <button type="submit" className="w-full bg-yellow-500 text-black font-bold px-4 py-2 rounded hover:bg-yellow-400">
...
//         <button onClick={handleLogout} className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-400">
//     Logout
//   </button>
//   </div>
//       <Toaster />
...
//               <button onClick={() => setView('create')} className={`px-4 py-2 rounded ${view === 'create' ? 'bg-yellow-500 text-black' : 'bg-gray-700 text-white'}`}>
//                 {editingEvent ? 'Edit Event' : 'Create Event'}
//               </button>
//               <button onClick={() => setView('manage')} className={`px-4 py-2 rounded ${view === 'manage' ? 'bg-yellow-500 text-black' : 'bg-gray-700 text-white'}`}>
//                 Manage Events ({events.length})
//               </button>
//             </div>
//             <div className="flex flex-col items-end gap-2">
//   <div className="bg-gray-800 p-2 px-4 rounded text-sm border border-gray-700">
...
//             {editingEvent && (
//               <button onClick={handleCancelEdit} className="mb-4 bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-500">
//                 Cancel Edit
//               </button>
//             )}
//             <div>
...
//               <DatePicker selected={watch('date')} onChange={(date: Date | null) => date && setValue('date', date)} className="w-full p-2 bg-[#1a1a1a] rounded border border-gray-600 text-white" placeholderText="Select event date" />
...
//               <input type="file" {...register('image', { required: !editingEvent })} accept="image/*" className="text-white" />
//               {image?.[0] && <img src={URL.createObjectURL(image[0])} className="mt-2 h-32 rounded object-cover" />}
//               {!image?.[0] && editingEvent?.image_url && <img src={editingEvent.image_url} className="mt-2 h-32 rounded object-cover" />}
//               {errors.image && <p className="text-red-500 text-sm">{errors.image.message}</p>}
//             </div>

//             <button type="submit" className="bg-yellow-500 text-black font-bold px-4 py-2 rounded hover:bg-yellow-400">
...
//                       <p className="text-yellow-400 mb-4">{new Date(event.date).toLocaleDateString()}</p>
//                       <div className="flex gap-2">
//                         <button onClick={() => handleEdit(event)} className="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-400 text-sm">
//                           Edit
//                         </button>
//                         <button onClick={() => handleDelete(event)} className="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-400 text-sm">
//                           Delete
//                         </button>
//                       </div>
//                     </div>
...
//                 className="w-full p-2 bg-[#1a1a1a] rounded border border-gray-600 text-white"
...
//             <div>
//               <label className="block mb-1 font-semibold">IMAGE {editingEvent && '(optional)'}</label>
//               <input type="file" {...register('image', { required: !editingEvent })} accept="image/*" className="text-white cursor-pointer border-2 w-49 rounded" />
//               {image?.[0] && <img src={URL.createObjectURL(image[0])} alt="Preview" className="mt-2 h-32 rounded object-cover" />}
//               {!image?.[0] && editingEvent?.image_url && <img src={editingEvent.image_url} alt={editingEvent.title} className="mt-2 h-32 rounded object-cover" />}
//               {errors.image && <p className="text-red-500 text-sm">{errors.image.message}</p>}
//             </div>
...
// export default AdminPage;
// ======Above is the complete admin page======================================
